...
public class Semantico implements Constants {
	...
	public void executeAction(int action, Token token, String input) throws SemanticError {
		...
		switch (action) {
		case 1:
			discoverActionType(token, input);
			codigo.add("add");
			break;
		case 2:
			discoverActionType(token, input);
		...
		case 6:
			...
			break;
		case 7:
			checkTypeArithmeticExpression(token, input);
			break;
		case 8:
			checkTypeArithmeticExpression(token, input);
			codigo.add("ldc.i8 -1");
		...
		case 12:
			...
			break;
		case 13:
			checkTypeLogicExpression(token, input);
			codigo.add("ldc.i4.1");
			codigo.add("not");
			break;
		case 14:
	...
	private void checkTypeLogicExpression(Token token, String input) throws SemanticError {
		String tipo1;
		tipo1 = pilhaDeTipos.pop();
	...
	private void checkTypeArithmeticExpression(Token token, String input) throws SemanticError {
		String tipo1;
		tipo1 = pilhaDeTipos.pop();
	...
	private void discoverActionType(Token token, String input) throws SemanticError {
		String tipo1;
		String tipo2;
		tipo1 = pilhaDeTipos.pop();
		tipo2 = pilhaDeTipos.pop();
	...
	private void throwSemanticException(String tipo1, String tipo2, String mensagemErro, Token token, String input)
